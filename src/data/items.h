...
// Poké Balls
    ...
    [ITEM_ULTRA_BALL] =
    {
        ...
        .price = ((I_PRICE >= GEN_7) ? 800 : 1200) * I_BALL_PRICE_MULT,
        .description = COMPOUND_STRING(
            "A better Ball with\n"
            "a higher catch rate\n"
            "than a Great Ball."),
    ...
    [ITEM_PREMIER_BALL] =
    {
        ...
        .price = ((I_PRICE >= GEN_7) ? 20 : 200) * I_BALL_PRICE_MULT,
        .description = COMPOUND_STRING(
            "A rare Ball made\n"
            "in commemoration\n"
            "of some event."),
    ...
    [ITEM_LUXURY_BALL] =
    {
        ...
        .price = ((I_PRICE >= GEN_8) ? 3000 : 1000) * I_BALL_PRICE_MULT,
        .description = COMPOUND_STRING(
            "A cozy Ball that\n"
            "makes Pokémon\n"
            "more friendly."),
    ...
    [ITEM_LEVEL_BALL] =
    {
        ...
        .price = ((I_PRICE >= GEN_7) ? 0 : 300) * I_BALL_PRICE_MULT,
        .description = COMPOUND_STRING(
            "A Ball that works\n"
            "well on lower\n"
            "level Pokémon."),
    ...
    [ITEM_SPORT_BALL] =
    {
        ...
        .price = ((I_PRICE <= GEN_3 || I_PRICE >= GEN_9) ? 0 : 300) * I_BALL_PRICE_MULT,
        .description = COMPOUND_STRING(
            "A special Ball\n"
            "used in the Bug-\n"
            "Catching Contest."),
