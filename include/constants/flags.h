...
#define FLAG_SYS_CRAFTING                            (SYSTEM_FLAGS + 0x3)
...
// Recipe flags track which recipes are unlocked
#define RECIPE_FLAGS_START                          (SYSTEM_FLAGS + 0x85)
